...
set -U fish_user_paths "/Users/ging/.nvm/versions/node/v8.9.1/bin" $fish_user_paths
set -U fish_user_paths /usr/local/Cellar/pyenv/1.1.2/libexec /Users/ging/.pyenv/shims $fish_user_paths
